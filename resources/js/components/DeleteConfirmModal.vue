...
const hasPermission = computed(() => can('maestros.delete'));
</script>
                ...
                <div class="p-8 text-center">
                    ...
                    <div class="mt-4 p-3 bg-red-500/5 rounded-lg border border-red-500/10">
                        <p class="text-[9px] font-black text-red-400 uppercase tracking-[0.2em]">
                            ⚠ Esta acción es irreversible en el sistema web
                        </p>
                    </div>
                </div>
            ...
            <template v-else>
                <div class="p-10 text-center">
                    ...
                    <p class="text-[11px] text-muted-foreground uppercase tracking-wider leading-relaxed">
                        No posees credenciales de nivel <span class="text-amber-500">Administrador Web</span> para ejecutar bajas en el catálogo.
                    </p>
